        ...
        <div class="small_nav">
            <div class="nav1 d-flex">
                ...
                <div class="store d-flex">
                    <img class="store_img pcur" src="../../assets/icon_Star.png" alt=""
                        v-if="dataInfo.isCollected === false" @click="store()">
                    <img class="store_img pcur" src="../../assets/icon_Star(1).png" alt=""
                        v-if="dataInfo.isCollected === true" @click="unstore()">
...
export default {
    ...
    mounted() {
        ...
        const dp = new DPlayer({
            ...
            screenshot: true,
            video: {
                url: process.env.VUE_APP_BASE_URL + '/video/view/' + this.videoID,
            },
        });
    },
    methods: {
